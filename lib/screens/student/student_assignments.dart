...
class StudentAssignments extends StatefulWidget {
  @override
  _StudentAssignments createState() => new _StudentAssignments();
}

class _StudentAssignments extends State<StudentAssignments> {
